...
# Form implementation generated from reading ui file 'rnd_param_view.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_4.addWidget(self.toolButton_result, 0, 7, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.toolButton_rm_check, 0, 8, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.toolButton_dict1, 0, 5, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.toolButton_dict2, 0, 6, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_open_file, 0, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_xlsx, 0, 4, 1, 1)
        self.pushButton_open_folder = QtWidgets.QPushButton(Form)
        self.pushButton_open_folder.setStyleSheet("background-color: rgb(175, 255, 242)")
        self.pushButton_open_folder.setObjectName("pushButton_open_folder")
        self.gridLayout_4.addWidget(self.pushButton_open_folder, 0, 2, 1, 1)
        self.pushButton_open_xlsx = QtWidgets.QPushButton(Form)
        self.pushButton_open_xlsx.setStyleSheet("background-color: rgb(85, 170, 255)")
        self.pushButton_open_xlsx.setObjectName("pushButton_open_xlsx")
        self.gridLayout_4.addWidget(self.pushButton_open_xlsx, 0, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.line, 0, 7, 1, 1)
        ...
        self.toolButton_draw_bar2 = QtWidgets.QToolButton(Form)
        self.toolButton_draw_bar2.setStyleSheet("background-color: rgb(220, 138, 221);")
        self.toolButton_draw_bar2.setText("")
        self.toolButton_draw_bar2.setObjectName("toolButton_draw_bar2")
        self.gridLayout_5.addWidget(self.toolButton_draw_bar2, 0, 30, 1, 1)
        self.label_5 = QtWidgets.QLabel(Form)
        self.label_5.setStyleSheet("background-color: rgb(153, 193, 241);")
        self.label_5.setObjectName("label_5")
        self.gridLayout_5.addWidget(self.label_5, 0, 0, 1, 1)
        self.toolButton_copy_param = QtWidgets.QToolButton(Form)
        self.toolButton_copy_param.setStyleSheet("background-color: rgb(170, 0, 255);")
        self.toolButton_copy_param.setObjectName("toolButton_copy_param")
        self.gridLayout_5.addWidget(self.toolButton_copy_param, 0, 25, 1, 1)
        self.label_3 = QtWidgets.QLabel(Form)
        self.label_3.setStyleSheet("background-color: rgb(143, 240, 164);")
        self.label_3.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_3.setObjectName("label_3")
        self.gridLayout_5.addWidget(self.label_3, 0, 16, 1, 1)
        self.label_4 = QtWidgets.QLabel(Form)
        self.label_4.setStyleSheet("background-color: rgb(87, 227, 137);")
        self.label_4.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_4.setObjectName("label_4")
        self.gridLayout_5.addWidget(self.label_4, 0, 18, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.doubleSpinBox_to_param, 0, 19, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.label, 0, 12, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.label_2, 0, 14, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.doubleSpinBox_from_z, 0, 21, 1, 1)
        self.toolButton_draw_bar1 = QtWidgets.QToolButton(Form)
        self.toolButton_draw_bar1.setStyleSheet("background-color: rgb(255, 190, 111);")
        self.toolButton_draw_bar1.setText("")
        self.toolButton_draw_bar1.setObjectName("toolButton_draw_bar1")
        self.gridLayout_5.addWidget(self.toolButton_draw_bar1, 0, 29, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.toolButton_draw_graph, 0, 28, 1, 1)
        ...
        self.doubleSpinBox_to_result.setMinimum(0.0)
        ...
        self.gridLayout_5.addWidget(self.doubleSpinBox_to_result, 0, 15, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.doubleSpinBox_to_z, 0, 23, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.doubleSpinBox_from_param, 0, 17, 1, 1)
        ...
        self.doubleSpinBox_from_result.setMinimum(-1.0)
        ...
        self.gridLayout_5.addWidget(self.toolButton_3d, 0, 24, 1, 1)
        self.spinBox_copy_param = QtWidgets.QSpinBox(Form)
        self.spinBox_copy_param.setStyleSheet("background-color: rgb(170, 0, 255);")
        self.spinBox_copy_param.setMaximum(500)
        self.spinBox_copy_param.setObjectName("spinBox_copy_param")
        self.gridLayout_5.addWidget(self.spinBox_copy_param, 0, 26, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_open_folder.setText(_translate("Form", "OPEN FOLDER"))
        self.pushButton_open_xlsx.setText(_translate("Form", "OPEN EXCEL"))
        ...
        self.comboBox_z.setItemText(3, _translate("Form", "RECALL"))
        self.comboBox_z.setItemText(4, _translate("Form", "PRECISION"))
        self.comboBox_z.setItemText(5, _translate("Form", "F1"))
        self.comboBox_z.setItemText(6, _translate("Form", "ALL PARAM"))
        self.comboBox_z.setItemText(7, _translate("Form", "CATEGORY"))
        self.comboBox_z.setItemText(8, _translate("Form", "MAE"))
        self.comboBox_z.setItemText(9, _translate("Form", "MSE"))
        self.comboBox_z.setItemText(10, _translate("Form", "R2"))
        self.comboBox_z.setItemText(11, _translate("Form", "sig up"))
        self.comboBox_z.setItemText(12, _translate("Form", "sig down"))
        self.comboBox_z.setItemText(13, _translate("Form", "width"))
        self.comboBox_z.setItemText(14, _translate("Form", "distr"))
        self.comboBox_z.setItemText(15, _translate("Form", "sep"))
        self.comboBox_z.setItemText(16, _translate("Form", "mfcc"))
        self.toolButton_draw_bar2.setToolTip(_translate("Form", "graph BAR2"))
        self.label_5.setText(_translate("Form", "X:"))
        self.toolButton_copy_param.setText(_translate("Form", " "))
        ...
        self.comboBox_x.setItemText(5, _translate("Form", "MAE"))
        self.comboBox_x.setItemText(6, _translate("Form", "MSE"))
        self.comboBox_x.setItemText(7, _translate("Form", "R2"))
        self.comboBox_x.setItemText(8, _translate("Form", "sig up"))
        self.comboBox_x.setItemText(9, _translate("Form", "sig down"))
        self.comboBox_x.setItemText(10, _translate("Form", "width"))
        self.comboBox_x.setItemText(11, _translate("Form", "distr"))
        self.comboBox_x.setItemText(12, _translate("Form", "sep"))
        self.comboBox_x.setItemText(13, _translate("Form", "mfcc"))
        ...
        self.comboBox_y.setItemText(7, _translate("Form", "MAE"))
        self.comboBox_y.setItemText(8, _translate("Form", "MSE"))
        self.comboBox_y.setItemText(9, _translate("Form", "R2"))
        self.comboBox_y.setItemText(10, _translate("Form", "sig up"))
        self.comboBox_y.setItemText(11, _translate("Form", "sig down"))
        self.comboBox_y.setItemText(12, _translate("Form", "width"))
        self.comboBox_y.setItemText(13, _translate("Form", "distr"))
        self.comboBox_y.setItemText(14, _translate("Form", "sep"))
        self.comboBox_y.setItemText(15, _translate("Form", "mfcc"))
        ...
        self.toolButton_draw_bar1.setToolTip(_translate("Form", "graph BAR1"))
