...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_5.addWidget(self.label, 0, 7, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.doubleSpinBox_from_result, 0, 8, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.doubleSpinBox_to_result, 0, 10, 1, 1)
        self.label_2 = QtWidgets.QLabel(Form)
        self.label_2.setStyleSheet("background-color: rgb(98, 160, 234);")
        self.label_2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_2.setObjectName("label_2")
        self.gridLayout_5.addWidget(self.label_2, 0, 9, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.label_3, 0, 11, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.toolButton_draw_graph, 0, 15, 1, 1)
        ...
        self.comboBox_z.addItem("")
        self.comboBox_z.addItem("")
        self.gridLayout_5.addWidget(self.comboBox_z, 0, 5, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.doubleSpinBox_from_param, 0, 12, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.doubleSpinBox_to_param, 0, 14, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_x.setItemText(4, _translate("Form", "distr"))
        self.comboBox_x.setItemText(5, _translate("Form", "sep"))
        self.comboBox_x.setItemText(6, _translate("Form", "mfcc"))
        ...
        self.comboBox_y.setItemText(6, _translate("Form", "distr"))
        self.comboBox_y.setItemText(7, _translate("Form", "sep"))
        self.comboBox_y.setItemText(8, _translate("Form", "mfcc"))
        ...
        self.comboBox_z.setItemText(7, _translate("Form", "distr"))
        self.comboBox_z.setItemText(8, _translate("Form", "sep"))
        self.comboBox_z.setItemText(9, _translate("Form", "mfcc"))
